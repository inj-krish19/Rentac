...
<?php
    ...
    if( $conn ){
        // echo "<div class='alert alert-success' role='success'><h1>Connection Established Successfully</h1></div>";
    }else{
        echo "<div class='alert alert-danger' role='success'><h1>Internal Server Error</h1></div>";
    }
