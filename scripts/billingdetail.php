                    ...
                    <li>
                      <div class="txt-holder">
                        ...
                        <div class="text-wrap txt text-right pull-right">
                          ...
                          <span><i class="fa fa-rupee"></i> 299,00</span>
                          <span><i class="fa fa-rupee"></i> 532,00</span>
                        </div>
                      </div>
                    </li>
                    <li>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                          <p>Make your payment directly to delivery person. Please use your order id as the payment reference. Your order wont be replaced after accepting.</p>
                        </div>
                      </div>
                    </div>
